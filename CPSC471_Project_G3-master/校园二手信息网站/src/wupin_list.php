...
<title><?=$bclass_name?>列表   -<?=$web_name?></title>
...
<table width="780" align="center" border="0" cellspacing="0" cellpadding="0" class="page">
      ...
      <tr>
	   ...
	   <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
		   ...
		   <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td height="25" bgcolor="#DFF1DC">&nbsp;<strong><font color="#09933"><?=$bclass_name?>列表</font></strong></td>
             </tr>
			 <tr>
               <td height="10"></td>
             </tr>
             <?
  $sql  = "select  count(*)  count  from ershou_wupin where bclass_name='$bclass_name' and wupin_guoqi='1'";  
 ...
 $sqlwupin="select * from ershou_wupin where bclass_name='$bclass_name' and wupin_guoqi='1' ORDER BY wupin_time desc limit $start,20";  
 ...
 echo '<tr><td height="25">&nbsp;&nbsp;<font color="#333333">['.$rswupin->class_name.']</font> <a href="wupin.php?wid='.$wid.'" target="_blank"><font color="#333333">'.TrimChinese($wupin_name,"80").'</font></a> <font color="#666666">('.$date_format.')</font></td>
  ...
  $str  = "<font color='#333333'>共 $recountCount 条，当前第 ".($page+1)."/$totalPage 页</font>&nbsp;";
  $str .= $isFirst?   "首页&nbsp;"   : "<a href=\"?bcid=".$bcid."&page=0\"><font color='#333333'>首页</font></a>&nbsp;";
  $str .= $hasNoPre?  "上一页&nbsp;" : "<a href=\"?bcid=".$bcid."&page=".($page-1)."\"><font color='#333333'>上一页</font></a>&nbsp;";
  $str .= $hasNoNext? "下一页&nbsp;" : "<a href=\"?bcid=".$bcid."&page=".($page+1)."\"><font color='#333333'>下一页</font></a>&nbsp;";
  $str .= $isLast?    "尾页&nbsp;"   : "<a href=\"?bcid=".$bcid."&page=".($totalPage-1)."\"><font color='#333333'>尾页</font></a>";
  echo $str;
  echo "</td></tr>";
  echo "</table>";  
			    ?></td>
